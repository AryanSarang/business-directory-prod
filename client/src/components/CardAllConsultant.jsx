        ...
        <div className="w-full relative basis-1/1 mx-auto py-5 md:basis-1/3 shrink-0 p-3 max-w-sm bg-white border border-gray-200 rounded-lg shadow ">
            ...
            <div className="flex flex-col items-center py-3">
                ...
                <span className="mb-1 flex gap-1 items-center text-xl font-medium text-gray-900 gilroy-bold">{consultant.name}
                    <svg className='w-6 h-6' xmlns="http://www.w3.org/2000/svg" id="Layer_1" enable-background="new 0 0 120 120" height="512" viewBox="0 0 120 120" width="512"><g>
                ...
                <div className="flex mt-4 gap-3 md:mt-6">
                    <a href="#" className="inline-flex items-center px-6 py-2 text-sm tracking-wider font-medium text-center text-white bg-green-700 rounded-lg hover:shadow-sm hover:shadow-green-300 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 ">Book</a>
